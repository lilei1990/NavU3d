...
public class UTMRef extends CoordinateSystem {
     ...
     * @param latZone  the latitude zone character.
     * @param lngZone  the longitude zone number.
     * @throws NotDefinedOnUTMGridException if any of the parameters are invalid. Be careful that a valid
     ...
     *
     * @param latitude the latitude to find the UTM latitude zone for
