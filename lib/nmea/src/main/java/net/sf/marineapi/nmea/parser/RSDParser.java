...
public class RSDParser extends SentenceParser implements RSDSentence {
    ...
    /**
     * @see RSDSentence#setOriginOneRange(double)
     */
    ...
    /**
     * @see RSDSentence#setOriginOneBearing(double)
     */
    ...
    /**
     * @see RSDSentence#setVRMOneRange(double)
     */
    ...
    /**
     * @see RSDSentence#setEBLOneBearing(double)
     */
    ...
    /**
     * @see RSDSentence#setOriginTwoRange(double)
     */
    ...
    /**
     * @see RSDSentence#setOriginTwoBearing(double)
     */
    ...
    /**
     * @see RSDSentence#setVRMTwoRange(double)
     */
    ...
    /**
     * @see RSDSentence#setEBLTwoBearing(double)
     */
    ...
    /**
     * @see RSDSentence#setCursorRange(double)
     */
    ...
    /**
     * @see RSDSentence#setCursorBearing(double)
     */
    ...
    /**
     * @see RSDSentence#setRangeScale(double)
     */
    ...
    /**
     * @see RSDSentence#setRangeUnits(Units)
     */
    ...
    /**
     * @see RSDSentence#setDisplayRotation(DisplayRotation)
     */
